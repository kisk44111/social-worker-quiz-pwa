const CACHE = 'social-worker-quiz-v13';
const DATA_CACHE = 'social-worker-quiz-data-v13';
const ASSETS = ['./','./index.html','./styles.css?build=9','./theme.css?build=9','./desktop.css?build=9','./readability.css?build=13','./app.js?build=13','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
